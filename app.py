...
def showCatalog():
    ...
    return render_template('catalog.html',
                            ...
                            items = items, logged_session= login_session)
...
def showCategory(category_name):
    ...
    if 'username' not in login_session or creator.id != login_session['user_id']:
        ...
        flash('{}, you can delete this category as you created this!'.format(user.name))
...
def showItem(category_name, item_name):
    ...
    if 'username' not in login_session or creator.id != login_session['user_id']:
        ...
        user = getUserInfo(login_session['user_id'])
        flash('{}, you can edit or delete this item as you created this!'.format(user.name))
...
def deleteCategory(category_name):
     ...
     if request.method =='POST':
         ...
         flash('Action cannot be reversed!')
...
# Edit an item
@app.route('/catalog/<path:item_name>/edititem', methods=['GET', 'POST'])
@login_required
